...
(function() {
  ...
  ready = function() {
    var mostrar_campos_condicionais;
    ...
    $(".photos.sortable").sortable({
      update: function(e, ui) {
        ...
        return $.post(window.location.pathname + "/sort", obj.sortable("serialize"), function() {
          return obj.effect("highlight");
        });
      }
    });
    mostrar_campos_condicionais = function() {
      $(".enrollment_category").change(function() {
        var campo_selecionado, campos_condicionais;

        campos_condicionais = $(".enrollment_entity");
        campos_condicionais.parent().hide();
        campo_selecionado = $(".enrollment_category :checked").val();
        if (campo_selecionado === "Associado de entidade apoiadora") {
          return $(".enrollment_entity").parent().slideDown();
        }
      });
      $(".enrollment_receipt_person").change(function() {
        var campo_selecionado, campos_condicionais;
        ...
        if (campo_selecionado === "cpf") {
          return $(".enrollment_cpf").parent().slideDown();
        } else if (campo_selecionado === "cnpj") {
          return $(".enrollment_cnpj, .enrollment_state_register").parent().slideDown();
        }
      });
      $(".enrollment_how_did_you_knew_us").change(function() {
        var campo_selecionado, campos_condicionais;

        campos_condicionais = $(".enrollment_how_exactly_did_you_knew_us");
        campos_condicionais.parent().hide();
        return campo_selecionado = $(".enrollment_how_did_you_knew_us :checked").val();
      });
      $(".enrollment_receipt_person").change();
      $(".enrollment_how_did_you_knew_us").change();
      return $(".enrollment_category").change();
    };
    $(window).load(function() {
      return mostrar_campos_condicionais();
    });
    return $(window).load();
  };
